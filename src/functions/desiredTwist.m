function x_des_dt = desiredTwist(P_L_cur,R_cur,P_L_des,R_des)
...
R_e = R_des * R_cur.';
theta_e = acos((trace(R_e)-1)/2); % ensure theta_e is positive %orientation error
...
m_e_hat = (1/(2*sin(theta_e))) * [R_e(3,2)-R_e(2,3);R_e(1,3)-R_e(3,1);R_e(2,1)-R_e(1,2)];
